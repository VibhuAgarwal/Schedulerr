    ...
    <main className="container mx-auto px-4 py-16">
      <div className="flex flex-col lg:flex-row items-center justify-center gap-12 mb-24">
        <div className="lg:w-1/2">
          <h1 className="text-7xl font-extrabold pb-6 gradient-title capitalize">
            Simplify your Scheduling
          </h1>
          <p className="text-xl text-gray-600 mb-10">
            Schedulerr is an app that simplifies your scheduling. Create an
            event, invite your team, and get ready to schedule.
          </p>
          <Link href="/dashboard">
            <Button size="lg" className="text-lg">
              Get Started <ArrowRight className="ml-2 h-5 2-5" />
            </Button>
          </Link>
        </div>
      ...
      <div className="bg-blue-600 text-white rounded-lg p-8 text-center">
        ...
        <p className="text-xl mb-6">Join thousands of professionals who already use Schedulerr for efficient time management. </p>
        <Link href={"/dashboard"}>
